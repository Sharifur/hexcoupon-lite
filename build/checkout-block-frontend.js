...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"hex-coupon-for-woocommerce/store-credit","version":"1.0.0","title":"Store Credit","category":"woocommerce","parent":["woocommerce/checkout-order-summary-block"],"attributes":{"lock":{"type":"object","default":{"remove":true,"move":true}}},"textdomain":"hex-coupon-for-woocommerce","editorScript":"file:./index.js"}');
...
const Block = ({
  ...
  }, storeCredit && (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Store Credit Used: -", "hex-coupon-for-woocommerce"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("b", {
    ref: myRef
  }, storeCredit && deductedTotal.toFixed(2)))));
};
const options = {
...
/******/ })()
;
//# sourceMappingURL=checkout-block-frontend.js.map