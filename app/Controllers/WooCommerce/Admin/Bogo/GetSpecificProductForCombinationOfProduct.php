...
class GetSpecificProductForCombinationOfProduct extends BaseController
{
	 ...
	 * @author WpHex
	 * @since 1.0.0
	 * @method customer_gets_a_specific_product_against_a_combination_of_product
	 * @return mixed
	 * Customer gets a specific product against a combination of product
	 */
	public function customer_gets_a_specific_product_against_a_combination_of_product( $customer_purchases, $customer_gets_as_free, $main_product_id, $coupon_id, $free_item_id, $wc_cart )
	{
