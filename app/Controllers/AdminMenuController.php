...
class AdminMenuController extends BaseController
{
	...
	{
		add_menu_page(
			esc_html__( 'HexCoupon', 'hexcoupon-advance-coupons-for-woocommerce' ),
			esc_html__( 'HexCoupon', 'hexcoupon-advance-coupons-for-woocommerce' ),
			'manage_options',
			'hexcoupon-page',
		...
		add_submenu_page(
			...
			esc_html__( 'All Coupons', 'hexcoupon-advance-coupons-for-woocommerce' ),
			esc_html__( 'All Coupons', 'hexcoupon-advance-coupons-for-woocommerce' ),
			'manage_options',
	...
	public function add_addnew_coupon_submenu()
	{
		add_submenu_page(
			'hexcoupon-page',
			esc_html__( 'Add Coupon', 'hexcoupon-advance-coupons-for-woocommerce' ),
			esc_html__( 'Add Coupon', 'hexcoupon-advance-coupons-for-woocommerce' ),
			'manage_options',
			'add_new_coupon',
	...
	public function add_coupon_category_submenu()
	{
		add_submenu_page(
			'hexcoupon-page',
			esc_html__( 'Coupon Category', 'hexcoupon-advance-coupons-for-woocommerce' ),
			esc_html__( 'Coupon Category', 'hexcoupon-advance-coupons-for-woocommerce' ),
			'manage_options',
			'coupon_category',
