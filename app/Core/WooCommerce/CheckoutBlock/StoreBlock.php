...
class StoreBlock {
	...
	public function register() {
		add_action( 'woocommerce_store_api_checkout_update_order_from_request', array( &$this, 'update_order_meta_for_store_credit' ), 10, 2 );
		add_action( 'admin_post_store_credit_deduction_save', [ $this, 'store_credit_deduction_save' ] );
	}
	 ...
	 */
	public function store_credit_deduction_save()
	{
	 ...
	 * @return void
	 * Updating order meta and storing 'deducted_store_credit' amount in the order details
	 */
